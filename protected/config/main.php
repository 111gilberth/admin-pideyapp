...
return array(
	'name'=>'Anmol Agarwal Food Delivery System',
	...
	'components'=>array(		   
		...
		'db'=>array(	        
		    'class'            => 'CDbConnection' ,
			'connectionString' => 'mysql:host=localhost;dbname=pideyappcom_pideyapp',
			'emulatePrepare'   => true,
			'username'         => 'pideyappcom_root1',
			'password'         => 'gC10099$2013',
			'charset'          => 'utf8',
			'tablePrefix'      => 'mt_',
	    ),	
	    ...
	    'Smtpmail'=>array(
	        ...
	        'Host'=>"mail.pideyapp.com.mx",
            'Username'=>'info@pideyapp.com.mx',
            'Password'=>'gC10099$2013',
            'Mailer'=>'smtp',
            'Port'=>26, // change this port according to your mail server
            'SMTPAuth'=>true,   
            'ContentType'=>'UTF-8',
            //'SMTPSecure'=>'ssl'// tls
	    ), 
