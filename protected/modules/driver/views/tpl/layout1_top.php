...
die();*/
?>
<input type="hidden" value="<?php echo $idAdmin; ?>" id="idAdmin"/>
<!--<script>
    id = document.getElementById("idAdmin").value
    console.log(window.location.href)
    
    if((id!=1 && (window.location.href=="https://pideyapp.com.mx/driver/index/agents" ) || (id!=1 &&  window.location.href=="https://pideyapp.com.mx/driver/index/assignment")){
       window.location.href = "https://pideyapp.com.mx/driver/index/agents"
    }
</script>-->
