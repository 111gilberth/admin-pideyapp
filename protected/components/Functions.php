	...
	public function adminMenu()
	{
		return array(  
		    ...
		    'items'=>array(
                ...
                'tag'=>"tags",'label'=>'<i class="fa fa-motorcycle"></i>'.Yii::t("default","Repartidores"),
                'url'=>array('/driver/index/agents')),
                ...
                'tag'=>"themesettings",'label'=>'<i class="fa fa-cogs"></i>'.t("Theme settings"),
                ...
                'tag'=>"voucher",
                'label'=>'<i class="fa fa-gift"></i>'.Yii::t("default","Voucher"),
                ...
                array('visible'=>$this->AA('withdrawal'),'tag'=>'withdrawal',
                   ...
                   'items'=>array(        
                     ...
                     'url'=>array('admin/incomingwithdrawal')),                                
                      ...
                      'label'=>'<i class="fa fa-cogs"></i>'.Yii::t("default","Settings"), 
                     'url'=>array('admin/withdrawalsettings')),                                   
                 )),          
                                
                array('visible'=>$this->AA('emailsettings'),'tag'=>"emailsettings",
                'label'=>'<i class="fa fa-cogs"></i>'.Yii::t("default","Email Settings"),
